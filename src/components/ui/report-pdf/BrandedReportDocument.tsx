...
const styles = StyleSheet.create({
  ...
  metaLabel: { color: t.color.neutral[500], fontSize: 7.25, fontWeight: 500, marginRight: 3 },
  metaValue: { color: t.color.neutral[800], fontSize: 7.25, fontWeight: 500 },
  ...
  highlightLabel: { color: t.color.neutral[500], fontSize: 6.75, fontWeight: 500, marginBottom: 3, textTransform: 'uppercase', letterSpacing: 0.45 },
  ...
  tableHeaderCell: { color: t.color.neutral[0], fontSize: 7, fontWeight: 600, paddingLeft: 6, paddingRight: 2, paddingVertical: 6 },
